...
$Host.UI.RawUI.WindowTitle = "disable updates"
...
try {
	...
	Invoke-WebRequest -Uri 'https://github.com/tsgrgo/windows-update-disabler/releases/latest/download/windows-update-disabler-main.zip' -OutFile $zip -ErrorAction Stop	
	...
	try {
		...
		Invoke-WebRequest -Uri "https://github.com/ChrisTitusTech/winutil/raw/refs/heads/main/functions/public/Invoke-WPFUpdatesdisable.ps1" -OutFile "$env:TEMP\Invoke-WPFUpdatesdisable.ps1" -UseBasicParsing
		. "$env:TEMP\Invoke-WPFUpdatesdisable.ps1"
