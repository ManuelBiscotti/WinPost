...
$Host.UI.RawUI.WindowTitle = 'Telemetry (Revert)'
$ProgressPreference = 'SilentlyContinue'  
$ErrorActionPreference = 'SilentlyContinue'
Clear-Host

# WindowsSpyBlocker
cmd /c "curl.exe -Lo %tmp%\WindowsSpyBlocker.exe https://github.com/crazy-max/WindowsSpyBlocker/releases/latest/download/WindowsSpyBlocker.exe"
cmd /c "(echo 1 & timeout /t 1 >nul & echo 1 & timeout /t 1 >nul & echo 4 & timeout /t 1 >nul & echo exit) | %tmp%\WindowsSpyBlocker.exe"
Clear-Host

# Win11Debloat
cmd /c "curl.exe -Lo %tmp%\Enable_Telemetry.reg https://github.com/Raphire/Win11Debloat/raw/refs/heads/master/Regfiles/Undo/Enable_Telemetry.reg && reg.exe import %tmp%\Enable_Telemetry.reg"
cmd /c "curl.exe -Lo %tmp%\Allow_Edge_Telemetry.reg https://github.com/Raphire/Win11Debloat/raw/refs/heads/master/Regfiles/Undo/Allow_Edge_Telemetry.reg && reg.exe import %tmp%\Allow_Edge_Telemetry.reg"
...
cmd /c "curl.exe -Lo %tmp%\latest.zip https://wpd.app/get/latest.zip && tar -xf %tmp%\latest.zip -C %tmp% && %tmp%\WPD.exe -wfpOnly -wfp off -default -close"
Clear-Host
...
# OOSU10.exe <percorso del file >
#
# In seguito alla selezione dell’opzione /quiet 
# L’applicazione termina l'importazione e l'utente non
# riceve nessun feedback a proposito.
#
# Siamo sempre liete di rispondere alle tue domande !
...
cmd /c "curl.exe -Lo %tmp%\OOSU10.exe https://dl5.oo-software.com/files/ooshutup10/OOSU10.exe && %tmp%\OOSU10.exe %tmp%\ooshutup10.cfg /quiet"

# privacy.sexy
# Start-Process "$env:LOCALAPPDATA\Programs\privacy.sexy\Uninstall privacy.sexy.exe"-ArgumentList "/S" -Wait
.\privacy.sexy\privacy-script (revert).bat
