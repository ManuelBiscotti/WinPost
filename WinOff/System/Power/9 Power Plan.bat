...
Get-ChildItem 'HKLM:\SYSTEM\CurrentControlSet\Control\Power\PowerSettings' -Recurse | ForEach-Object { Set-ItemProperty $_.PSPath -Name Attributes -Value 0 -ErrorAction SilentlyContinue | Out-Null }														
...
Clear-Host
# restores all power settings back to default
Get-ChildItem 'HKLM:\SYSTEM\CurrentControlSet\Control\Power\PowerSettings' -Recurse | ForEach-Object { Set-ItemProperty -Path $_.PSPath -Name Attributes -Value 1 -ErrorAction SilentlyContinue | Out-Null }
# restore powerplans
